...
?>
  ...
  <div class="wrap-select">
      <div class="options">
      <h4>ค้นหา</h4>
      <form method="POST" action="./AdDashBoard_Month.php" enctype="multipart/form-data">
            <select name="year">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <?php //--------------------------------------------------------input variable----------------------------------
                                            ...
                                            JOIN donationtype ON store.Store_Maindonation = donationtype.DonationType_ID
                                                WHERE  
                                                YEAR(orderdetail.OrderDetail_Updatetime ) = '$year'
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <?php 
                                  ...
                                  JOIN donationtype ON store.Store_Maindonation = donationtype.DonationType_ID
                                  WHERE
                                       YEAR(orderdetail.OrderDetail_Updatetime ) = '$year' AND MONTH(orderdetail.OrderDetail_Updatetime) = '$month'
                                       AND orderdetail.OrderDetail_Status IN ('finish','complete')";
                                      // echo $query;
                                  $result = mysqli_query($conn, $query);
                                  $resultchart = mysqli_query($conn, $query);
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <?php //--------------------------------------------------------input variable----------------------------------
                                            ...
                                            SUM(
                                                ...
                                                JOIN store ON product.Store_ID = store.Store_ID
                                                JOIN donationtype ON store.Store_Maindonation = donationtype.DonationType_ID
                                                WHERE YEAR(orderdetail.OrderDetail_Updatetime ) = '$year' AND MONTH(orderdetail.OrderDetail_Updatetime) = '$month'
                                                AND orderdetail.OrderDetail_Status IN ('finish','complete')
                                                GROUP By
                                                    DATE_FORMAT(orderdetail.OrderDetail_Updatetime, '%d%')
                                                ORDER BY
                              ...
                              <div class="table-responsive">
                                ...
                                <?php //--------------------------------------------------------input Table----------------------------------;
                                        ...
                                        END
                                            ...
                                            JOIN store ON product.Store_ID = store.Store_ID
                                            JOIN donationtype ON store.Store_Maindonation = donationtype.DonationType_ID 
                                            WHERE YEAR(orderdetail.OrderDetail_Updatetime ) LIKE '%$year%' AND MONTH(orderdetail.OrderDetail_Updatetime) = '$month'
                                            AND orderdetail.OrderDetail_Status IN ('finish','complete')
                                            ...
                                            echo "  <td><a href=\"./StAdDashBoard_Month.php?storeid=$row[5]\">ดูเพิ่มเติม</a></td>";
                                            echo "</tr>";
