        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <hr class="sidebar-divider my-0">
                    <li class="nav-item active">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="../Store_manage.php">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="../Donation_manage.php">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="AdDashBoard_Year.php">
...
<?php
 ...
 if (isset($_POST['selectquarter'])){
   ...
   $quater = trim($_POST['quater']);
 }
?>
      <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" class="active"><a href="./AdDashBoard_Year.php" aria-controls="home" role="tab">รายปี</a></li>
                  <li role="presentation" class="active"><a href="./AdDashBoard_Quarter.php" aria-controls="profile" role="tab" >ไตรมาส</a></li>
                  <li role="presentation"class="active" ><a href="./AdDashBoard_Month.php" aria-controls="messages" role="tab" >รายเดือน</a></li>
  ...
  <div class="wrap-select">
      <div class="options">
      <h4>ค้นหา</h4>
      <form method="POST" action="./AdDashBoard_Quarter.php" enctype="multipart/form-data">
            <select name="year">
            ...
            <select name="quater">
              <option value=''   <?php if ($quater == "") echo "selected"; ?>>Choose</option>
              <option value="1' And '3" <?php if ($quater == "1' And '3") echo "selected"; ?>>1</option>
              <option value="4' And '6" <?php if ($quater == "4' And '6") echo "selected"; ?>>2</option>
              <option value="7' And '9" <?php if ($quater == "7' And '9") echo "selected"; ?>>3</option>
              <option value="10' And '12" <?php if ($quater == "10' And '12") echo "selected"; ?>>4</option>
            </select>  
      ...
      <input type="submit" name="selectquarter" value="ค้นหา">
      </form>   
      </div>  
                                ...
                                <?php //--------------------------------------------------------input variable----------------------------------
                                            ...
                                            SELECT
                                                SUM(
                                                    ...
                                                    DATE_FORMAT(orderdetail.OrderDetail_Updatetime, '%M') AS datesave
                                                FROM
                                                    orderdetail
                                                ...
                                                WHERE  
                                                YEAR(orderdetail.OrderDetail_Updatetime ) LIKE '%$year%'
                                                AND Month(orderdetail.OrderDetail_Updatetime) BETWEEN '$quater'
                                                GROUP By
                                                    DATE_FORMAT(orderdetail.OrderDetail_Updatetime, '%m%')
                                                ORDER BY
                                                    DATE_FORMAT(orderdetail.OrderDetail_Updatetime, '%m%')
                                                ;";
                                            //    echo $query;
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <?php 
                                  ...
                                  JOIN donationtype ON store.Store_Maindonation = donationtype.DonationType_ID
                                  WHERE
                                       YEAR(orderdetail.OrderDetail_Updatetime ) LIKE '%$year%' AND Month(orderdetail.OrderDetail_Updatetime) BETWEEN '$quater'";
                                      // echo $query;
                                  $result = mysqli_query($conn, $query);
                                  $resultchart = mysqli_query($conn, $query);
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <?php //--------------------------------------------------------input variable----------------------------------
                                          ...
                                          END
                                                ...
                                                JOIN store ON product.Store_ID = store.Store_ID
                                                JOIN donationtype ON store.Store_Maindonation = donationtype.DonationType_ID
                                                WHERE YEAR(orderdetail.OrderDetail_Updatetime ) LIKE '%$year%' AND Month(orderdetail.OrderDetail_Updatetime) BETWEEN '$quater'
                                                GROUP By
                                                    DATE_FORMAT(orderdetail.OrderDetail_Updatetime, '%m%')
                                                ORDER BY
                                                    DATE_FORMAT(orderdetail.OrderDetail_Updatetime, '%m%')
                          ...
                          <div class="card-body">
                              <div class="table-responsive">
                                ...
                                <?php //--------------------------------------------------------input Table----------------------------------;
                                            ...
                                            SUM(orderdetail.Product_Price) AS totalsum,
                                            SUM(orderdetail.Product_Quantity) AS totalqua,
                                            SUM(
                                              (
                                                  orderdetail.Product_Price
                                              ) -(
                                        ...
                                        END
                                            ...
                                            echo "  <td>$row[9]</td>";                                    
                                            echo "  <td>$row[12] ชิ้น</td>";
                                            echo "  <td>$row[11] บาท</td>";
                                            echo "  <td>$row[13] บาท</td>";
                                            echo "  <td>$row[14] บาท</td>";
                                            echo "  <td><a href=\"./StAdDashBoard_Quarter.php?storeid=$row[5]\">ดูเพิ่มเติม</a></td>";
                                            echo "</tr>";
