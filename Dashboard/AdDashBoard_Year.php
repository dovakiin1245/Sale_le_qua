...
?>
  ...
  <div class="wrap-select">
      <div class="options">
      <h4>ค้นหา</h4>
      <form method="POST" action="./AdDashBoard_Year.php" enctype="multipart/form-data">
            <select name="year">
      ...
      <input type="submit" name="selectyear" value="ค้นหา">
      </form>   
      </div>  
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <?php //--------------------------------------------------------input variable----------------------------------
                                            ...
                                            SELECT
                                                ...
                                                WHERE YEAR(orderdetail.OrderDetail_Updatetime ) = '$year'  AND orderdetail.OrderDetail_Status IN ('finish','complete')
                                                GROUP By
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <?php 
                                  ...
                                  JOIN donationtype ON store.Store_Maindonation = donationtype.DonationType_ID
                                  WHERE
                                       YEAR(orderdetail.OrderDetail_Updatetime ) = '$year'  AND orderdetail.OrderDetail_Status IN ('finish','complete')";
                                      // echo $query;
                                  $result = mysqli_query($conn, $query);
                                  $resultchart = mysqli_query($conn, $query);
                                ...
                                <?php //--------------------------------------------------------input Table----------------------------------;
                                          ...
                                          END
                                            ...
                                            while($row = mysqli_fetch_array($result)){
                                              ...
                                              echo "  <td><a href=\"./StAdDashBoard_Year.php?storeid=$row[5]\">ดูเพิ่มเติม</a></td>";
                                              echo "</tr>";
