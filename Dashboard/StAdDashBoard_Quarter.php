...
?>
      <ul class="nav nav-tabs" role="tablist">
                  <li role="presentation" class="active"><a href="./StAdDashboard_Year.php?storeid=<?php echo "$sid";?> " aria-controls="home" role="tab">รายปี</a></li>
                  <li role="presentation" class="active"><a href="./StAdDashboard_Quarter.php?storeid=<?php echo "$sid";?> " aria-controls="profile" role="tab" >ไตรมาส</a></li>
                  <li role="presentation"class="active" ><a href="./StAdDashboard_Month.php?storeid=<?php echo "$sid";?> " aria-controls="messages" role="tab" >รายเดือน</a></li>
  ...
  <div class="wrap-select">
      <div class="options">
      <h4>ค้นหา</h4>
      <form method="POST" action="./StAdDashboard_Quarter.php?storeid=<?php echo "$sid";?>" enctype="multipart/form-data">
            <select name="year">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <?php 
                                  ...
                                  JOIN donationtype ON store.Store_Maindonation = donationtype.DonationType_ID
                                  WHERE
                                      store.Store_ID = '$sid' AND orderdetail.OrderDetail_Status IN ('finish','complete') AND YEAR(orderdetail.OrderDetail_Updatetime ) = '$year' AND Month(orderdetail.OrderDetail_Updatetime) BETWEEN '$quater'";
                                      // echo $query;
                                  $result = mysqli_query($conn, $query);
                                  $resultchart = mysqli_query($conn, $query);
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <?php //--------------------------------------------------------input variable----------------------------------
                                          ...
                                          END
                                                ...
                                                JOIN store ON product.Store_ID = store.Store_ID
                                                JOIN donationtype ON store.Store_Maindonation = donationtype.DonationType_ID
                                                WHERE store.Store_ID = '$sid' AND orderdetail.OrderDetail_Status IN ('finish','complete') AND YEAR(orderdetail.OrderDetail_Updatetime ) = '$year' AND Month(orderdetail.OrderDetail_Updatetime) BETWEEN '$quater'
                                                GROUP By
                                                    DATE_FORMAT(orderdetail.OrderDetail_Updatetime, '%m%')
                                                ORDER BY
                                                    DATE_FORMAT(orderdetail.OrderDetail_Updatetime, '%m%')
