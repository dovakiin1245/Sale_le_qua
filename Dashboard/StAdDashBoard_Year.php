...
?>
  ...
  <div class="wrap-select">
      <div class="options">
      <h4>ค้นหา</h4>
      <form method="POST" action="./StAdDashboard_Year.php?storeid=<?php echo "$sid";?>" enctype="multipart/form-data">
            <select name="year">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <?php //--------------------------------------------------------input variable----------------------------------
                                            ...
                                            SELECT
                                                ...
                                                WHERE store.Store_ID = '$sid' AND orderdetail.OrderDetail_Status IN ('finish','complete') AND YEAR(orderdetail.OrderDetail_Updatetime ) LIKE '%$year%'
                                                GROUP By
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <?php 
                                  ...
                                  JOIN donationtype ON store.Store_Maindonation = donationtype.DonationType_ID
                                  WHERE
                                      store.Store_ID = '$sid' AND orderdetail.OrderDetail_Status IN ('finish','complete') AND YEAR(orderdetail.OrderDetail_Updatetime ) LIKE '%$year%'";
                                      // echo $query;
                                  $result = mysqli_query($conn, $query);
                                  $resultchart = mysqli_query($conn, $query);
